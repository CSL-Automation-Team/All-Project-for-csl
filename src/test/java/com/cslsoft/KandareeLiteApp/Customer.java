...
//Create Customers.............
		 ...
		 driver.findElementByXPath("//android.view.ViewGroup[@content-desc=\"Photo taken on Nov 12, 2020 5:00:24 PM\"]").click();
...
// Update...........................
		...
		for(int i=0;i<xyz1.size();i++)
			{
				if(xyz1.get(i).getText().contains("Create New Customer"))
					{
					    driver.findElementByXPath("//android.widget.TextView[@text='Create New Customer']").click();
						driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
